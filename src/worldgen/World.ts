...
export class World {
  ...
  r_raw_temp: Float32Array;
  p_atmos_thermal_energy: Float32Array;
  ...
  static create(options: IGlobeOptions, mapMode: EMapMode): World {
    ...
    world.p_moisture = new Float32Array(world.mesh.numRegions);
    world.r_heat_loss = new Float32Array(world.mesh.numRegions);
    world.r_raw_temp = new Float32Array(world.mesh.numRegions);
    world.p_atmos_thermal_energy = new Float32Array(world.mesh.numRegions);
    world.r_average_temperature = new Float32Array(world.mesh.numRegions);
  ...
  public export(): WorldExport {
    return {
      ...
      r_average_temperature: this.r_average_temperature
    }
  }
